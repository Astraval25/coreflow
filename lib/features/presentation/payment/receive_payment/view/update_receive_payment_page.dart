...
import 'package:coreflow/features/presentation/payment/receive_payment/viewmodel/update_receive_payment_view_model.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (customer.customerCompanyName.isNotEmpty)
                                Text(customer.customerCompanyName,
                                    style: TextStyle(
                                        fontSize: 12.5,
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  style:
                      TextStyle(fontSize: 15, color: LoginColors.textPrimary),
                  onChanged: (v) {
