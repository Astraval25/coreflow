...
import 'package:coreflow/features/main_feature/customers/widget/edit_create/billing_address_card.dart';
import 'package:coreflow/features/main_feature/customers/widget/edit_create/customer_info_def_section.dart';
import 'package:coreflow/features/main_feature/customers/widget/edit_create/customer_info_section.dart';
import 'package:coreflow/features/main_feature/customers/widget/edit_create/save_customer_button.dart';
import 'package:coreflow/features/main_feature/customers/widget/edit_create/shipping_address_card.dart';
  ...
  Future<void> _saveCustomer(CustomerEditViewModel viewModel) async {
    ...
    final request = CreateCustomerRequest(
      ...
      shippingAddress: ShippingAddress(
        ...
        pincode: int.tryParse(_shippingPincodeController.text.trim()) ?? 0,
