...
import 'package:coreflow/features/main_feature/payment/send_payment/viewmodel/send_payment_detail_view_model.dart';
import 'package:coreflow/core/theme/colors.dart';
import 'package:flutter/material.dart';

class SendPaymentBottomPanel extends StatefulWidget {
  final PaymentDetail payment;
  final SendPaymentDetailViewModel vm;

  const SendPaymentBottomPanel({
    super.key,
  ...
  @override
  State<SendPaymentBottomPanel> createState() => _SendPaymentBottomPanelState();
}

class _SendPaymentBottomPanelState extends State<SendPaymentBottomPanel>
  ...
  void _onDragUpdate(DragUpdateDetails details) {
    ...
    final delta = -primaryDelta / _expandedHeight;
