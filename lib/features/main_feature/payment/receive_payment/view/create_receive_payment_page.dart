...
import 'package:coreflow/features/main_feature/payment/receive_payment/viewmodel/create_receive_payment_view_model.dart';
...
class _CreateReceivePaymentViewState extends State<_CreateReceivePaymentView> {
  ...
  Widget _buildReceivePaymentButton(CreateReceivePaymentViewModel vm) {
    return SizedBox(
      ...
      child: FilledButton.icon(
        ...
        label: Text(
          vm.isLoading ? 'Saving Payment...' : 'Receive Payment',
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: rowDecoration.copyWith(
