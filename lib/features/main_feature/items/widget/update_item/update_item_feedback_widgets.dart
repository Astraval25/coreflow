...
class UpdateItemErrorMessage extends StatelessWidget {
  final String message;

  const UpdateItemErrorMessage({super.key, required this.message});
...
class UpdateItemLoadingOverlay extends StatelessWidget {
  const UpdateItemLoadingOverlay({super.key});
