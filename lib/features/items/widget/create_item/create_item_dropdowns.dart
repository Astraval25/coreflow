...
class CreateItemTypeDropdown extends StatelessWidget {
  final String value;
  final ValueChanged<String?> onChanged;

  const CreateItemTypeDropdown({
    super.key,
    required this.value,
...
class CreateItemUnitDropdown extends StatelessWidget {
  final String? selectedUnit;
  final List<String> unitOptions;
  final ValueChanged<String?> onChanged;

  const CreateItemUnitDropdown({
    super.key,
