...
class SelectCompanyItemPage extends StatefulWidget {
  final CustomerDetailViewModel viewModel;

  const SelectCompanyItemPage({super.key, required this.viewModel});

  @override
  State<SelectCompanyItemPage> createState() => _SelectCompanyItemPageState();
}

class _SelectCompanyItemPageState extends State<SelectCompanyItemPage> {
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          final created = await Navigator.of(context)
                              .push<bool>(
                                MaterialPageRoute(
                                  builder: (_) => CreateCustomerItemPage(
...
class CreateCustomerItemPage extends StatefulWidget {
  final CustomerDetailViewModel viewModel;
  final Item item;

  const CreateCustomerItemPage({
    super.key,
  ...
  @override
  State<CreateCustomerItemPage> createState() => _CreateCustomerItemPageState();
}

class _CreateCustomerItemPageState extends State<CreateCustomerItemPage> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  Future<void> _submit() async {
    ...
    final created = await widget.viewModel.createCustomerItem(
      itemId: widget.item.itemId,
      salesPrice: price,
      salesDescription: _descriptionController.text.trim(),
    );
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        surfaceTintColor: Colors.transparent,
        foregroundColor: Colors.white,
        title: const Text('Create Customer Item'),
        leading: IconButton(
          tooltip: 'Menu',
          onPressed: () => _scaffoldKey.currentState?.openDrawer(),
          icon: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                validator: (value) {
                  final v = (value ?? '').trim();
                  if (v.isEmpty) return 'Sales price is required';
              ...
              CustomTextField(
                ...
                hintText: 'Special price reason / customer note',
              ...
              SizedBox(
                ...
                child: CustomButton(
                  ...
                  text: _isSubmitting ? 'Creating...' : 'Create Customer Item',
                ),
              ),
            ],
          ),
...
class UpdateCustomerItemPage extends StatefulWidget {
  final CustomerDetailViewModel viewModel;
  final CustomerMappedItem item;

  const UpdateCustomerItemPage({
    super.key,
    required this.viewModel,
    required this.item,
  });
  ...
  @override
  State<UpdateCustomerItemPage> createState() => _UpdateCustomerItemPageState();
}

class _UpdateCustomerItemPageState extends State<UpdateCustomerItemPage> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  late final TextEditingController _priceController;
  ...
  Future<void> _submit() async {
    ...
    setState(() => _isSubmitting = true);
    final updated = await widget.viewModel.updateCustomerItem(
      itemId: widget.item.itemId,
      salesPrice: price,
      salesDescription: _descriptionController.text.trim(),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        surfaceTintColor: Colors.transparent,
        foregroundColor: Colors.white,
        title: const Text('Update Customer Item'),
        leading: IconButton(
          tooltip: 'Menu',
          onPressed: () => _scaffoldKey.currentState?.openDrawer(),
          icon: Container(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CustomButton(
                  ...
                  text: _isSubmitting ? 'Updating...' : 'Update Customer Item',
                ),
              ),
            ],
          ),
